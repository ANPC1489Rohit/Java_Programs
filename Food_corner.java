 				...
 				switch(order)
 				{
 					case 1:
 						...
 						do{
 							...
 							{
 								System.out.println("Your Veg Crispy will be served shortly");
 								amount=amount+110;
 							}
 							else if(sub_veg==4)
 							{
 								System.out.println("Your Spring Rolls will be served shortly");
 								amount=amount+120;
 							}
 							else
 							{
 					...
 					case 2:
 						...
 						do{
 							...
 							{
 								System.out.println("Your Biryani will be served shortly");
 								amount=amount+150;
 							}
 							else if(sub_veg==4)
 							{
 								System.out.println("Your Chole Bhature will be served shortly");
 								amount=amount+160;
 							}
 							else
 							{
 					...
 					case 3:
 						...
 						do{
 							...
 							{
 								System.out.println("Your Waffle will be served shortly");
 								amount=amount+190;
 							}
 							else if(sub_veg==4)
 							{
 								System.out.println("Your Gulab Jamun will be served shortly");
 								amount=amount+200;
 							}
 							else
 							{
